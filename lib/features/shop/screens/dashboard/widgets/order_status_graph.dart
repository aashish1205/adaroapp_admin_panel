import 'package:adaroapp_admin_panel/common/widgets/containers/circular_container.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return TRoundedContainer(
      child: Column(
        ...
        children: [
          Text('Orders Status', style: Theme.of(context).textTheme.headlineMedium),
              ...
              PieChartData(
                ...
                pieTouchData: PieTouchData(
                  touchCallback: (FlTouchEvent event, pieTouchResponse) {
                    // Handle touch evets here if needed
                  },
                  enabled: true,
                )
              ),
