...
class TWeeklySalesGraph extends StatelessWidget {
          ...
          () => controller.weeklySales.isNotEmpty
              ...
              child: BarChart(
                BarChartData(
                    ...
                    barGroups: controller.weeklySales.asMap().entries.map((entry) => BarChartGroupData(x: entry.key,
                        barRods: [
                          BarChartRodData(
                            width: 30,
                            toY: entry.value,
  ...
  FlTitlesData buildFlTitlesData(RxList<double> weeklySales) {
    // Calculate ste height for the left pricing
      ...
      bottomTitles: AxisTitles(
          sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta){
                // Map index to the desire day of the week
