import 'package:adaroapp_admin_panel/common/widgets/layouts/sidebars/sidebar_controller.dart';
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                // Icon
                Padding(
                  padding: EdgeInsets.only(left: TSizes.lg, top: TSizes.md, bottom: TSizes.md, right: TSizes.md),
